...
namespace AduSkin.Controls.Metro
{
    ...
    /// 带三角形的气泡边框
    /// </summary>
    public class AduAngleBorder : Decorator
    {
        #region 依赖属性
        public static readonly DependencyProperty PlacementProperty =
            DependencyProperty.Register("Placement", typeof(EnumPlacement), typeof(AduAngleBorder),
        ...
        public static readonly DependencyProperty TailWidthProperty =
            DependencyProperty.Register("TailWidth", typeof(double), typeof(AduAngleBorder), new PropertyMetadata(10d));
        /// <summary>
        /// 尾巴的宽度，默认值为7
        /// </summary>
        ...
        public static readonly DependencyProperty TailHeightProperty =
            DependencyProperty.Register("TailHeight", typeof(double), typeof(AduAngleBorder), new PropertyMetadata(10d));
        /// <summary>
        /// 尾巴的高度，默认值为10
        /// </summary>
        ...
        public static readonly DependencyProperty TailVerticalOffsetProperty =
            DependencyProperty.Register("TailVerticalOffset", typeof(double), typeof(AduAngleBorder), new PropertyMetadata(13d));
        /// <summary>
        /// 尾巴距离顶部的距离，默认值为10
        /// </summary>
        ...
        public static readonly DependencyProperty TailHorizontalOffsetProperty =
            DependencyProperty.Register("TailHorizontalOffset", typeof(double), typeof(AduAngleBorder),
        ...
        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.Register("Background", typeof(Brush), typeof(AduAngleBorder)
        ...
        public static readonly DependencyProperty PaddingProperty =
            DependencyProperty.Register("Padding", typeof(Thickness), typeof(AduAngleBorder)
        ...
        public static readonly DependencyProperty BorderBrushProperty =
            DependencyProperty.Register("BorderBrush", typeof(Brush), typeof(AduAngleBorder)
        ...
        public static readonly DependencyProperty BorderThicknessProperty =
            DependencyProperty.Register("BorderThickness", typeof(Thickness), typeof(AduAngleBorder), new PropertyMetadata(new Thickness(1d)));
        /// <summary>
        /// 边框大小
        /// </summary>
        ...
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register("CornerRadius", typeof(System.Windows.CornerRadius)
                , typeof(AduAngleBorder), new PropertyMetadata(new CornerRadius(0)));
        /// <summary>
        /// 边框大小
        /// </summary>
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            if (Child != null)
            {
                ...
                pen.Thickness = UIElementExtension.RoundLayoutValue(BorderThickness.Left, DoubleUtil.DpiScaleX);
        ...
        {
            AduAngleBorder angleBorder = d as AduAngleBorder;
            if(angleBorder != null)
            {

...
{
    public class AduAnimationPath : Shape
    {
        ...
        public static readonly DependencyProperty DataProperty = DependencyProperty.Register(nameof(Data),
            typeof(Geometry), typeof(AduAnimationPath), new FrameworkPropertyMetadata(null,
                OnPropertiesChanged));

        private static void OnPropertiesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is AduAnimationPath path)
            {
                path.UpdatePath();
            }
        }
        ...
        public static readonly DependencyProperty PathLengthProperty = DependencyProperty.Register(
            "PathLength", typeof(double), typeof(AduAnimationPath), new FrameworkPropertyMetadata(ValueBoxes.Double0Box, OnPropertiesChanged));
        ...
        public static readonly DependencyProperty DurationProperty = DependencyProperty.Register(
            "Duration", typeof(Duration), typeof(AduAnimationPath), new FrameworkPropertyMetadata(new Duration(TimeSpan.FromSeconds(2)),
                OnPropertiesChanged));
        ...
        public static readonly DependencyProperty IsPlayingProperty = DependencyProperty.Register(
            "IsPlaying", typeof(bool), typeof(AduAnimationPath), new FrameworkPropertyMetadata(true, (o, args) =>
            {
                var ctl = (AduAnimationPath)o;
        ...
        public static readonly DependencyProperty RepeatBehaviorProperty = DependencyProperty.Register(
            "RepeatBehavior", typeof(RepeatBehavior), typeof(AduAnimationPath), new PropertyMetadata(RepeatBehavior.Forever));
        ...
        static AduAnimationPath()
        {
            ElementBase.DefaultStyle<AduAnimationPath>(DefaultStyleKeyProperty);
            StretchProperty.AddOwner(typeof(AduAnimationPath), new FrameworkPropertyMetadata(Stretch.Uniform,
                OnPropertiesChanged));

            StrokeThicknessProperty.AddOwner(typeof(AduAnimationPath), new FrameworkPropertyMetadata(1.0,
                OnPropertiesChanged));
        }

        public AduAnimationPath()
        {
        ...
        public static readonly RoutedEvent CompletedEvent =
              EventManager.RegisterRoutedEvent("Completed", RoutingStrategy.Bubble,
                  typeof(EventHandler), typeof(AduAnimationPath));

...
namespace AduSkin.Controls.Metro
{
   ...
   /// 星级评价控件
   /// </summary>
   public class AduRatingBar : Control
   {
      #region Private属性
      /// <summary>
      /// 保存评分控件内部的一个个子Item，比如一个个笑脸或者星星
      /// </summary>
      private ObservableCollection<AduRatingBarButton> RatingButtonsInternal = new ObservableCollection<AduRatingBarButton>();
      /// <summary>
      /// 该Command在样式xaml中执行
      /// </summary>
      ...
      public static readonly DependencyProperty MaximumProperty =
          DependencyProperty.Register("Maximum", typeof(int), typeof(AduRatingBar), new PropertyMetadata(5, MaximumChangedCallback));


      private static void MaximumChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
      {
         ((AduRatingBar)d).CreateRatingButtons();
      }
      #endregion
      ...
      public static readonly DependencyProperty MinimumProperty =
          DependencyProperty.Register("Minimum", typeof(int), typeof(AduRatingBar), new PropertyMetadata(1, MinimumChangedCallback, CoreMinimumCallback));
      ...
      public static readonly DependencyProperty ValueProperty =
          DependencyProperty.Register("Value", typeof(double), typeof(AduRatingBar), new PropertyMetadata(0d, ValueChangedCallback, ValueCoerce));

      private static object ValueCoerce(DependencyObject d, object baseValue)
      {
         AduRatingBar ratingBar = d as AduRatingBar;
         double value = 0.0;
      ...
      private static void ValueChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
      {
         ...
         var buttonList = ((AduRatingBar)d).RatingButtonsInternal;
         ...
         //{
         //    AduRatingBarButton ratingBarButton = buttonList[i];
      ...
      public static readonly DependencyProperty ValueItemTemplateProperty =
          DependencyProperty.Register("ValueItemTemplate", typeof(DataTemplate), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty ValueItemStyleProperty =
          DependencyProperty.Register("ValueItemStyle", typeof(Style), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty SelectedColorProperty =
          DependencyProperty.Register("SelectedColor", typeof(Brush), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty UnSelectedColorProperty =
          DependencyProperty.Register("UnSelectedColor", typeof(Brush), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty IsReadOnlyProperty =
          DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(AduRatingBar), new PropertyMetadata(false));
      #endregion
      ...
      public static readonly DependencyProperty ContentProperty =
          DependencyProperty.Register("Content", typeof(object), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty ContentTemplateProperty =
          DependencyProperty.Register("ContentTemplate", typeof(DataTemplate), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty ContentStringFormatProperty =
          DependencyProperty.Register("ContentStringFormat", typeof(string), typeof(AduRatingBar));
      #endregion
      ...
      public static readonly DependencyProperty IsShowContentProperty =
          DependencyProperty.Register("IsShowContent", typeof(bool), typeof(AduRatingBar), new PropertyMetadata(true));
      #endregion
      ...
      public static readonly DependencyProperty RatingButtonsProperty =
          DependencyProperty.Register("RatingButtons", typeof(IEnumerable), typeof(AduRatingBar));
      #endregion
      ...
      static AduRatingBar()
      {
         DefaultStyleKeyProperty.OverrideMetadata(typeof(AduRatingBar), new FrameworkPropertyMetadata(typeof(AduRatingBar)));
      }
      ...
      private void CreateRatingButtons()
      {
         ...
         {
            AduRatingBarButton button = new AduRatingBarButton()
            {
               Content = i,
               Value = i,

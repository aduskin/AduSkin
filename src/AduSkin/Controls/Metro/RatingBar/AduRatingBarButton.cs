...
{
    public class AduRatingBarButton : ButtonBase
    {
        #region Private属性
        ...
        public static readonly DependencyProperty IsSelectedProperty =
            DependencyProperty.Register("IsSelected", typeof(bool), typeof(AduRatingBarButton), new PropertyMetadata(false));
        #endregion
        ...
        public static readonly DependencyProperty IsHalfProperty =
            DependencyProperty.Register("IsHalf", typeof(bool), typeof(AduRatingBarButton), new PropertyMetadata(false));
        #endregion
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(int), typeof(AduRatingBarButton));
        #endregion
        ...
        public static readonly RoutedEvent ItemMouseEnterEvent = EventManager.RegisterRoutedEvent("ItemMouseEnter",
            RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<int>), typeof(AduRatingBarButton));
        ...
        #region Constructors
        static AduRatingBarButton()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(AduRatingBarButton), new FrameworkPropertyMetadata(typeof(AduRatingBarButton)));
        }
        #endregion

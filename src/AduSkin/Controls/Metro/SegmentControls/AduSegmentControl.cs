...
{
   /// <summary>
   /// 分段按钮控件，类似IOS的AduSegmentControl
   /// </summary>
   /// <remarks>add by zhidf 2017.7.9</remarks>
   public class AduSegmentControl : ListBox
   {
      ...
      public static readonly DependencyProperty CornerRadiusProperty =
          DependencyProperty.Register("CornerRadius", typeof(CornerRadius), typeof(AduSegmentControl));
      ...
      /// <summary>
      /// 获取或者设置SegmentItem的四周的圆角是否与AduSegmentControl一致
      /// </summary>
      [Bindable(true), Description("获取或者设置SegmentItem的四周的圆角是否与AduSegmentControl一致")]
      ...
      public static readonly DependencyProperty IsAllRoundProperty =
          DependencyProperty.Register("IsAllRound", typeof(bool), typeof(AduSegmentControl), new PropertyMetadata(false));
      ...
      public static readonly RoutedEvent ItemClickEvent = EventManager.RegisterRoutedEvent("ItemClick",
          RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<object>), typeof(AduSegmentControl));
      ...
      #region Constructors
      public AduSegmentControl()
      {

      }

      static AduSegmentControl()
      {
         DefaultStyleKeyProperty.OverrideMetadata(typeof(AduSegmentControl), new FrameworkPropertyMetadata(typeof(AduSegmentControl)));
      }
      ...
      protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
      {
         ...
         AduSegmentItem segmentItem = element as AduSegmentItem;
         if (segmentItem == null)
         {
            return;
         }
      ...
      private void SetSegmentItem(int index)
      {
         ...
         AduSegmentItem segmentItem = this.ItemContainerGenerator.ContainerFromIndex(index) as AduSegmentItem;
         if (segmentItem == null)
         {
            return;
         }

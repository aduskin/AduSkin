...
{
    public class AduSlideSwitchPanel : Canvas
    {
        ...
        public static RoutedEvent IndexChangedEvent = EventManager.RegisterRoutedEvent("IndexChanged", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<int>), typeof(AduSlideSwitchPanel));
        ...
        {
            AduSlideSwitchPanel panel = d as AduSlideSwitchPanel;
            if(e.Property == AduSlideSwitchPanel.IndexProperty)
            {

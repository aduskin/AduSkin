...
{
    [TemplatePart(Name = "PART_SlideSwitchPanel", Type = typeof(AduSlideSwitchPanel))]
    ...
    public class AduCarousel : Control
    {
        #region Private属性
        private AduSlideSwitchPanel PART_SlideSwitchPanel;
        ...
        static AduCarousel()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(AduCarousel), new FrameworkPropertyMetadata(typeof(AduCarousel)));
            AduCarousel.ItemsSourceProperty = DependencyProperty.Register("ItemsSource", typeof(IEnumerable), typeof(AduCarousel));
            AduCarousel.ItemTemplateProperty = DependencyProperty.Register("ItemTemplate", typeof(DataTemplate), typeof(AduCarousel));
            AduCarousel.AutoPlayProperty = DependencyProperty.Register("AutoPlay", typeof(bool), typeof(AduCarousel), new PropertyMetadata(false, OnAutoPlayChangedCallback));
            AduCarousel.AutoPlaySpeedProperty = DependencyProperty.Register("AutoPlaySpeed", typeof(double), typeof(AduCarousel), new PropertyMetadata(2d, OnAutoPlaySpeedChangedCallback));
        }
        ...
        {
            AduCarousel carousel = d as AduCarousel;
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.PART_SlideSwitchPanel = this.GetTemplateChild("PART_SlideSwitchPanel") as AduSlideSwitchPanel;
        ...
        {
            AduSlideSwitchPanel panel = sender as AduSlideSwitchPanel;

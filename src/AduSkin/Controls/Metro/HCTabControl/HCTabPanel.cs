...
namespace AduSkin.Controls.Metro
{
    public class HCTabPanel : Panel
    {
        ...
        ///     选项卡字典
        /// </summary>
        internal Dictionary<int, HCTabItem> ItemDic = new Dictionary<int, HCTabItem>();

        /// <summary>
        ///     流式行为持续时间
        /// </summary>
        public static readonly DependencyProperty FluidMoveDurationProperty = DependencyProperty.Register(
            "FluidMoveDuration", typeof(Duration), typeof(HCTabPanel), new PropertyMetadata(new Duration(TimeSpan.FromMilliseconds(200))));
        ...
        public static readonly DependencyProperty IsEnableTabFillProperty = DependencyProperty.Register(
            "IsEnableTabFill", typeof(bool), typeof(HCTabPanel), new PropertyMetadata(ValueBoxes.FalseBox));
        ...
        public static readonly DependencyProperty TabItemWidthProperty = DependencyProperty.Register(
            "TabItemWidth", typeof(double), typeof(HCTabPanel), new PropertyMetadata(200.0));
        ...
        public static readonly DependencyProperty TabItemHeightProperty = DependencyProperty.Register(
            "TabItemHeight", typeof(double), typeof(HCTabPanel), new PropertyMetadata(30.0));
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            for (var index = 0; index < count; index++)
            {
                ...
                if (InternalChildren[index] is HCTabItem tabItem)
                {

...
{
    public class AduCoverView : RegularItemsControl
    {
       static AduCoverView()
       {
         ElementBase.DefaultStyle<AduCoverView>(DefaultStyleKeyProperty);
       }
      private readonly AduCoverViewContent _viewContent;

        private AduCoverViewItem _selectedItem;

        private IEnumerable _itemsSourceInternal;

        private readonly Dictionary<object, AduCoverViewItem> _entryDic = new Dictionary<object, AduCoverViewItem>();

        private bool _isRefresh;

        public AduCoverView()
        {
            _viewContent = new AduCoverViewContent();

            AddHandler(SelectableItem.SelectedEvent, new RoutedEventHandler(AduCoverViewItem_OnSelected));
            _viewContent.SetBinding(AduCoverViewContent.ContentHeightProperty, new Binding(ItemContentHeightProperty.Name) { Source = this });
            _viewContent.SetBinding(WidthProperty, new Binding(ActualWidthProperty.Name) { Source = this });
        }

        private void AduCoverViewItem_OnSelected(object sender, RoutedEventArgs e)
        {
            if (e.OriginalSource is AduCoverViewItem item)
            {
                if (_selectedItem == null)
                {
                    ...
                    if (_viewContent != null)
                    {
                        ...
                        UpdateAduCoverViewContent(true);
                    }
                ...
                if (_viewContent != null)
                {
                    ...
                    UpdateAduCoverViewContent(false);
                }
                _selectedItem.IsSelected = false;
                _selectedItem = null;
            }
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (_selectedItem != null)
            {
                UpdateAduCoverViewContent(_selectedItem != null);
            }
        }

        protected override DependencyObject GetContainerForItemOverride() => new AduCoverViewItem();
        ...
        protected override bool IsItemItsOwnContainerOverride(object item) => item is AduCoverViewItem;

        public static readonly DependencyProperty CoverViewContentStyleProperty = DependencyProperty.Register(
            "CoverViewContentStyle", typeof(Style), typeof(AduCoverView), new PropertyMetadata(default(Style)));
        ...
        internal static readonly DependencyProperty GroupsProperty = DependencyProperty.Register(
            "Groups", typeof(int), typeof(AduCoverView),
        ...
        {
            if (d is AduCoverView ctl)
            {
                ctl.UpdateAduCoverViewContent(ctl._viewContent.IsOpen);
            }
        }
        ...
        public static readonly DependencyProperty ItemContentHeightProperty = DependencyProperty.Register(
            "ItemContentHeight", typeof(double), typeof(AduCoverView), new PropertyMetadata(ValueBoxes.Double300Box),
        ...
        public static readonly DependencyProperty ItemContentHeightFixedProperty = DependencyProperty.Register(
            "ItemContentHeightFixed", typeof(bool), typeof(AduCoverView), new PropertyMetadata(ValueBoxes.TrueBox));
        ...
        public static readonly DependencyProperty ItemHeaderTemplateProperty = DependencyProperty.Register(
            "ItemHeaderTemplate", typeof(DataTemplate), typeof(AduCoverView), new PropertyMetadata(default(DataTemplate)));
        ...
        protected override void Refresh()
        {
            ...
            UpdateAduCoverViewContent(_viewContent.IsOpen);
        }

        /// <summary>
        ///     更新内容视图
        /// </summary>
        private void UpdateAduCoverViewContent(bool isOpen)
        {
            ...
            UpdateAduCoverViewContentPosition();
        ...
        ///     更新内容视图位置
        /// </summary>
        private void UpdateAduCoverViewContentPosition()
        {
        ...
        private void InsertItem(int index, object item)
        {
            ...
            else
            {
                ...
                if (container is AduCoverViewItem element)
                {

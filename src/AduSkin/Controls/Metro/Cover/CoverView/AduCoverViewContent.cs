...
namespace AduSkin.Controls.Metro
{
    ...
    internal class AduCoverViewContent : ContentControl
    {
        ...
        internal static readonly DependencyProperty ManualHeightProperty = DependencyProperty.Register(
            "ManualHeight", typeof(double), typeof(AduCoverViewContent), new PropertyMetadata(ValueBoxes.Double0Box), ValidateHelper.IsInRangeOfPosDoubleIncludeZero);
        ...
        public static readonly DependencyProperty ContentHeightProperty = DependencyProperty.Register(
            "ContentHeight", typeof(double), typeof(AduCoverViewContent), new PropertyMetadata(ValueBoxes.Double300Box),

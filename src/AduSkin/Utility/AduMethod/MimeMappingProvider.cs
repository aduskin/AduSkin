...
{
    public class MimeMappingProvider
    {
        public static MimeMappingProvider Shared { get; } = new MimeMappingProvider();
        ...
        {
            // Copyed from https://github.com/dotnet/aspnetcore/blob/master/src/Middleware/StaticFiles/src/FileExtensionContentTypeProvider.cs
            { ".323", "text/h323" },
            { ".3g2", "video/3gpp2" },
            { ".3gp2", "video/3gpp2" },
            { ".3gp", "video/3gpp" },
